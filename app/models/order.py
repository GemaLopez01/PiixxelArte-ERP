...
class Order(db.Model):
    ...
    subtotal_amount = db.Column(db.Numeric(10, 2), default=0.0) # Suma de todos los artículos antes del descuento global
    discount_amount = db.Column(db.Numeric(10, 2), default=0.0) # Descuento manual global
    tax_amount = db.Column(db.Numeric(10, 2), default=0.0)      # IVA registrado explícitamente
    total_amount = db.Column(db.Numeric(10, 2), default=0.0)    # Monto final
